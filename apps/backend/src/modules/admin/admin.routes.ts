...
const ENV_GROUPS = {
  ...
  payments: {
    keys: ['PAYMENTS_ENABLED', 'STRIPE_ENABLED', 'STRIPE_SECRET_KEY', 'STRIPE_WEBHOOK_SECRET', 'YOOKASSA_ENABLED', 'YOOKASSA_SHOP_ID', 'YOOKASSA_SECRET_KEY', 'YOOKASSA_WEBHOOK_SECRET', 'YOOKASSA_IP_ALLOWLIST', 'ROBOKASSA_ENABLED', 'ROBOKASSA_MERCHANT_LOGIN', 'ROBOKASSA_PASSWORD1', 'ROBOKASSA_PASSWORD2', 'ROBOKASSA_TEST_MODE', 'PAYPAL_ENABLED', 'PAYPAL_CLIENT_ID', 'PAYPAL_CLIENT_SECRET', 'PAYPAL_WEBHOOK_ID', 'PAYPAL_MODE', 'POLAR_ENABLED', 'POLAR_ACCESS_TOKEN', 'POLAR_WEBHOOK_SECRET', 'POLAR_ORGANIZATION_ID', 'DODO_ENABLED', 'DODO_API_KEY', 'DODO_WEBHOOK_SECRET', 'PADDLE_ENABLED', 'PADDLE_API_KEY', 'PADDLE_WEBHOOK_SECRET', 'PADDLE_SANDBOX'],
    types: { PAYMENTS_ENABLED: 'boolean', STRIPE_ENABLED: 'boolean', STRIPE_SECRET_KEY: 'secret', STRIPE_WEBHOOK_SECRET: 'secret', YOOKASSA_ENABLED: 'boolean', YOOKASSA_SHOP_ID: 'secret', YOOKASSA_SECRET_KEY: 'secret', YOOKASSA_WEBHOOK_SECRET: 'secret', YOOKASSA_IP_ALLOWLIST: 'string', ROBOKASSA_ENABLED: 'boolean', ROBOKASSA_MERCHANT_LOGIN: 'secret', ROBOKASSA_PASSWORD1: 'secret', ROBOKASSA_PASSWORD2: 'secret', ROBOKASSA_TEST_MODE: 'boolean', PAYPAL_ENABLED: 'boolean', PAYPAL_CLIENT_ID: 'secret', PAYPAL_CLIENT_SECRET: 'secret', PAYPAL_WEBHOOK_ID: 'secret', PAYPAL_MODE: 'string', POLAR_ENABLED: 'boolean', POLAR_ACCESS_TOKEN: 'secret', POLAR_WEBHOOK_SECRET: 'secret', POLAR_ORGANIZATION_ID: 'secret', DODO_ENABLED: 'boolean', DODO_API_KEY: 'secret', DODO_WEBHOOK_SECRET: 'secret', PADDLE_ENABLED: 'boolean', PADDLE_API_KEY: 'secret', PADDLE_WEBHOOK_SECRET: 'secret', PADDLE_SANDBOX: 'boolean' } as Record<string, string>,
  },
  sms: {
