...
const ENV_GROUPS = {
  ...
  payments: {
    keys: ['PAYMENTS_ENABLED', 'STRIPE_ENABLED', 'STRIPE_SECRET_KEY', 'STRIPE_WEBHOOK_SECRET', 'YOOKASSA_ENABLED', 'YOOKASSA_SHOP_ID', 'YOOKASSA_SECRET_KEY', 'YOOKASSA_WEBHOOK_SECRET', 'ROBOKASSA_ENABLED', 'ROBOKASSA_MERCHANT_LOGIN', 'ROBOKASSA_PASSWORD1', 'ROBOKASSA_PASSWORD2', 'ROBOKASSA_TEST_MODE', 'PAYPAL_ENABLED', 'PAYPAL_CLIENT_ID', 'PAYPAL_CLIENT_SECRET', 'PAYPAL_WEBHOOK_ID', 'PAYPAL_MODE', 'POLAR_ENABLED', 'POLAR_ACCESS_TOKEN', 'POLAR_WEBHOOK_SECRET', 'POLAR_ORGANIZATION_ID', 'DODO_ENABLED', 'DODO_API_KEY', 'DODO_WEBHOOK_SECRET', 'PADDLE_ENABLED', 'PADDLE_API_KEY', 'PADDLE_WEBHOOK_SECRET', 'PADDLE_SANDBOX'],
